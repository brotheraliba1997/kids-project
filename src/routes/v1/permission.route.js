...
const { ProgramController, permissionController } = require('../../controllers');
...
router
  .route('/')
  .get(auth('getPrograms'),  permissionController.getAllPermission)
  .post(auth('manageProgram'),  permissionController.createPermission);
