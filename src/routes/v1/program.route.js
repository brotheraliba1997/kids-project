...
router
  .route('/')
  .get(auth('getPrograms'), validate(ProgramValidation.getPrograms), ProgramController.getAllPrograms)
  .post(auth('manageProgram'), validate(ProgramValidation.createProgram), ProgramController.createProgram);
